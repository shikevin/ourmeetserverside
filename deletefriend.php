...
if (isset($_POST['name1']) && isset($_POST['name2'])) {
    ...
    $query .= "DELETE FROM friends WHERE BINARY name1='$name1' AND BINARY name2='$name2';";
    $query .= "DELETE FROM friends WHERE BINARY name1='$name2' AND BINARY name2='$name1'";
    ...
    if ($success) {
        ...
        $response['message'] = $DELETED_FRIEND;
    } else {
        $response['success'] = false;
